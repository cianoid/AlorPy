...
Config.PortfolioStocks = "D00000"  # Фондовый рынок
Config.PortfolioFutures = "0000PST"  # Срочный рынок
Config.PortfolioFx = "G00000"  # Валютный рынок
Config.Accounts = {  # Привязка портфелей к биржам
    Config.PortfolioStocks: (
        "MOEX",
        "SPBX",
    ),  # Фондовый рынок на Московской Бирже (RUB) и СПб Бирже (USD)
    Config.PortfolioFutures: ("MOEX",),  # Срочный рынок на Московской Бирже (RUB)
    Config.PortfolioFx: ("MOEX",),
...
Config.Boards = {  # Привязка портфелей/серверов для стоп заявок к площадкам
    ...
    "RFUD": (Config.PortfolioFutures, FutServerCode),
}  # FORTS: Фьючерсы
...
ConfigIIA.Boards = {  # Привязка портфелей/серверов для стоп заявок к площадкам
    ...
    "RFUD": (ConfigIIA.PortfolioFutures, FutServerCode),
}  # FORTS: Фьючерсы
...
ConfigDemo.Boards = {  # Привязка портфелей/серверов для стоп заявок к площадкам
    ...
    "RFUD": (ConfigDemo.PortfolioFutures, FutServerCode),
}  # FORTS: Фьючерсы
